        ...
        <div className="relative h-[65vh] overflow-hidden">
            ...
            >
                ...
                <div className="p-6 rounded-lg text-white bg-red md:w-1/2 flex flex-col items-center">
                    ...
                    <button className="bg-red-600 w-fit text-white px-6 py-3 uppercase tracking-wide font-semibold hover:bg-red-700 transition-all duration-300 cursor-pointer">
                        Explore Classes
                    </button>
                </div>
